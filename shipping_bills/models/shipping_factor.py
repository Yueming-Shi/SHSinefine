...
class ShippingFactor(models.Model):
    ...
    vip_first_weight = fields.Float('VVIP首重')
    vip_first_total_price = fields.Float('VVIP首重总价')
    vip_next_weight_to_ceil = fields.Float('VVIP续重取整')
    vip_next_price_unit = fields.Float('VVIP续重单价')
